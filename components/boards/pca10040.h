...
#define SPIM2_SCK_PIN   2 // // SPI clock GPIO pin number.
#define SPIM2_MOSI_PIN  3 // // SPI Master Out Slave In GPIO pin number.
#define SPIM2_MISO_PIN  4 // // SPI Master In Slave Out GPIO pin number.
#define SPIM2_SS_PIN    5 // // SPI Slave Select GPIO pin number.
